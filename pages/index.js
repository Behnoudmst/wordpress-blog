...
export default function Home({ postsList }) {
  ...
  return (
    <>
      ...
      <section className="bg-gray-800 center p-10 py-20 lg:px-48 ">
      ...
      <section className="pb-8 bg-slate-700 lg:px-48 px-8">
      ...
      {/* ************blog section start ***************** */}
      <section className="pb-8 bg-slate-900 lg:px-48 px-8">
        <h2 className=" text-center text-white text-4xl ml-5 py-12">Blog</h2>
