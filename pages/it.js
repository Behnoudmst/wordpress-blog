  ...
  return (
    <>
      ...
      <section className=" lg:px-[25%] px-8 py-16 text-center text-white bg-slate-900">
        <h3 className="text-2xl lg:text-4xl leading-6">
          ...
          soluzione perfetta per te. <span className="underline italic text-slate-500 font-serif"><Link href="mailto:behnoud.mostafaie@gmail.com" >Contattami oggi</Link></span> per iniziare il tuo viaggio
